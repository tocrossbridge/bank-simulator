  ...
  <div v-if="modal.open" class="modal">
    <div class="modal__content">
      ...
      <div class="progress-element">
        <div
          class="progress-container progress-container-created"
          v-if="modal.data.status == 'created'"
        >
          <progress value="10" max="100"></progress>
        </div>
        <div
          class="progress-container progress-container-processing"
          v-if="modal.data.status == 'processing'"
        >
          <progress value="50" max="100"></progress>
        </div>
        <div
          class="progress-container progress-container-processed"
          v-if="modal.data.status == 'processed'"
        >
